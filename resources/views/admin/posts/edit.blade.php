                            ...
                            <div class="row gy-4">
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <select type="text" class="form-select" name="category_id" id="category_id">
                                            @foreach ($categories as $id => $name)
                                                <option @if ($id == $post->category->id) selected @endif
                                                    value="{{ $id }}">{{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <select type="text" class="form-select" name="author_id" id="author_id">
                                            @foreach ($authors as $id => $name)
                                                <option @if ($id == $post->author->id) selected @endif
                                                    value="{{ $id }}">{{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input type="file" class="form-control mb-3" name="img_thumbnail"
                                            id="img_thumbnail">
                                        <img src="{{ \Storage::url($post->img_thumbnail) }}" alt="" width="100%"
                                            height="260px">
                                    </div>
                                    <div class="mt-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-check form-switch form-switch-primary">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    name="is_active" id="is_active" @checked($post->is_active)>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check form-switch form-switch-warning">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    name="is_trending" id="is_trending" @checked($post->is_trending)>
