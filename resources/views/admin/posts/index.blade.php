                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if ($post->img_thumbnail && \Storage::exists($post->img_thumbnail))
                                            <li class="list-group-item">
                                                <img width="110px" height="100px"
                                                    src="{{ \Storage::url($post->img_thumbnail) }}" alt="">
                                            </li>
                                        @endif
                                    </td>
                                    <td>{{ $post->title }}</td>
                                    ...
                                    <td>{!! $post->is_trending ? '<span class="badge bg-primary">YES</span>' : '<span class="badge bg-danger">NO</span>' !!}</td>
                                    <td>
